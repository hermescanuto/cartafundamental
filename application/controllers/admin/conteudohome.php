...
class Conteudohome extends CI_Controller {
	...
	*/
	...
	function paging()
	{
		...
		$result=$this->util->PaginationOn($table,20,base_url().'admin/conteudohome/paging',$fields,$where,$orderby); // cria a paginação
