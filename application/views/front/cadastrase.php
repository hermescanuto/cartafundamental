	...
	<div class="container">
		...
		<div class="row barra_cinza">	
			<div class="col-lg-10 col-lg-offset-1 barra_cinza" id='barra_cinza'>
				<h4><span class="aspas">//</span>Cadastre-se</h4>
			</div>
		</div>
		<!-- Barra cinza   -->
		...
		<div class="row fundo_branco" id='barra_conteudo'>
			...
			<div class="col-lg-7 col-md-9 col-lg-offset-1 fundo_branco" id='coluna1'>	
				...
				<p>
					...
					<strong> Criar conta -</strong> <span><a href="https://vendas.assinaja.com/entitlement/empresa/editoraconfianca/CriarConta.aspx" target='assine'>Clique aqui</a></span>
					<br> 
					<strong>Usuário ou senha inválidos -</strong> <span><a href="http://www.cartacapital.com.br" target='assine'>Clique aqui</a></span>
					<br>
					<strong> Problemas no acesso -</strong> <span><a href="https://vendas.assinaja.com/entitlement/empresa/editoraconfianca/ProblemaAcesso.aspx" target='assine'>Clique aqui</a></span>
					<br>
					<strong> Esqueci minha senha -</strong> <span><a href="http://www.cartacapital.com.br" target='assine'>Clique aqui</a></span>
					<br>
				</p>
