	...
	<table border="0" class="table table-striped" width="80%">
		...
		<tbody>
			...
			<tr style='border: 1px solid black'>
				...
				</a> <a href='{base_url}admin/{local}/unlock/{id}'
					title='Libera a matéria para edição' data-toggle="tooltip" data-placement="top"
					rel="tooltip"><i class="icon-lock"></i>
				</a>
